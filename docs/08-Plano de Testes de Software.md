...
|:---:	|:---:	|
| **Caso de Teste** 	| **CT-05 – Recomendação de jogos para o usuário**	|
...
|:---:	|:---:	|
| **Caso de Teste** 	| **CT-07 – Favoritar os jogos escolhidos**|
...
|:---:	|:---:	|
| **Caso de Teste** 	| **CT-08 – Lista de favoritos no perfil do usuário**	|
...
|:---:	|:---:	|
| **Caso de Teste**	| **CT-09 – Personalização de foto de perfil do usuário**	|
...
|:---:	|:---:	|
| **Caso de Teste** 	| **CT-10 – Recomendação de jogos feitas de um usuário para o outro**	|
...
|:---:	|:---:	|
| **Caso de Teste**	| **CT-11 – Lista de recomendação de jogos feitas de um usuário para o outro**	|
